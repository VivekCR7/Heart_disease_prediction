...
def PredictRisk(request,pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            RFClassifier,KnnClassifier,NaiveBayesClassifier,DecisionTreeClassifier=GetAllClassifiersForHeart()


            predictions = {'RandomForest': str(RFClassifier.predict(features)[0]),
            ...
            l=[predictions['RandomForest'],predictions['KNN'],predictions['NaiveBayes'],predictions['DecisionTree']]
            count=l.count('1')
